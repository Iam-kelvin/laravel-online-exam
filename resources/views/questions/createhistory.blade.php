...
<div class="container">
	<div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header"><strong>Type in History Question</strong></div>

                <div class="card-body">
				<form method="post" action="{{ route('createhistory') }}">
					{{ csrf_field() }}
                    ...
                    <div class="form-group">
                        <input type="hidden" name="historyid" class="form-control" id="historyid" value="{{$history->id}}" readonly>
                    </div>
